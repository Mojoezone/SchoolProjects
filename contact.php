...
<div class="nav">
  ...
  <div>
    <div>
      <img src="images/contact1000.jpg" srcset="images/contact480.jpg 480w, images/contact768.jpg 768w, images/contact1000.jpg 1000w" sizes="(max-width: 530px) 480px,(max-width: 818px) 768px, 1000px" alt="SHIELD Contact" />
    </div>
  </div>
  ...
  <main>
    <div>
      ...
      <div class="aboutText">
        <div>
          <p><span>ADDRESS:</span><a href="https://www.google.com/maps/place/6308+La+Valle+Plateada,+Rancho+Santa+Fe,+CA+92067/@33.0254322,-117.2005869,17z/data=!3m1!4b1!4m5!3m4!1s0x80dc0993404e6357:0x56700114c06bb9e6!8m2!3d33.0254322!4d-117.1983982" target="_blank">6308 La Valle Plateada, Rancho Santa Fe, CA 92091</a></p>

        </div>

        <div>
          <p><span>PHONE NUMBER:</span><a href="tel:18001234567">1-800-123-4567</a></p>
        </div>
        <div>
          <?php
      ...
      <form action="contact.php" method="post" name="signup" id="signup">
        <label for="email">E-Mail</label>
        <input name="email" type="text" id="email" placeholder="youremail@name.com" focus required />
